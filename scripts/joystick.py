...
if __name__ == '__main__':
	...
	pubjoy01 = rospy.Publisher("/joy01", Joy, queue_size=1)
	pubjoy02 = rospy.Publisher("/joy02", Joy, queue_size=1)
	pubjoy03 = rospy.Publisher("/joy03", Joy, queue_size=1)
	pubjoy04 = rospy.Publisher("/joy04", Joy, queue_size=1)
